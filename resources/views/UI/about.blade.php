    ...
    <body>
                ...
                <div class="row d-flex align-items-center justify-content-center">
                    <div style="margin-top: 0px;padding: 76px 0px" class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Home </a>  
                            <span class="lnr lnr-arrow-right"></span>  <a href="about.html"> About Me</a>
                        </p>
                    </div>	
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 home-about-left">
                        <img class="img-fluid" src="{{asset('public/UI')}}/img/about-img.png" alt="">
                    </div>
        ...
        <section class="timeline pb-120">
            ...
            <ul>
                ...
                <li>
                    <div class="content">
                        <img class="img-fluid mx-auto d-block mb-30" src="{{asset('public/UI')}}/img/about/c-logo.png" alt="">
                        <h4>
