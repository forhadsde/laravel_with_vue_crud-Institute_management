...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section id="app"  class="content">
            <form action="<?php echo e(url('update-student',[$studentDetails->id])); ?>">
                <div class="form-group">
                    <label for="name">Name:</label>
                    <input type="text" value="<?php echo e($studentDetails->name); ?>"  name="name" class="form-control" id="name">
                </div>
                <div class="form-group">
                    <label for="roll">Roll:</label>
                    <input type="number" value="<?php echo e($studentDetails->roll); ?>" name="roll" class="form-control" id="roll">
                </div>
                <div class="form-group">
                    <label for="class">Select Class:</label>
                    <select  class="form-control" id="class" name="semester">
                        <?php $__currentLoopData = App\semesterlist::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\schoolmanagement\resources\views/Admin/student-edit.blade.php ENDPATH**/ ?>